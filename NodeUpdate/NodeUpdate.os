...
Процедура ВыполнитьПулФоновыхЗаданий()
	
	Конфигуратор.ЗапуститьВРежимеПредприятия(Параметры["ОбработкаФоновыхЗаданий"], Ложь);
	Логирование.ЗаписатьСтрокуЛога("Пул фоновых заданий выполнен");
